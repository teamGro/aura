/*
Данные между логотипами и карточками с их подробным описанием связываются 
через поля brandsData.id и brandDescData.title соответственно.
Для магазинов из раздела "Отделка и интерьер" необходимо добавлять поле
'classes' (для работы фильтров).
*/
let brandsData = [
  {
    category: 'shop-soft',
